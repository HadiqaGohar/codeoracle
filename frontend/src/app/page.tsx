          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {features.map((f) => (
                <div
                  key={f.label}
                  className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5 hover:border-violet-500/50 hover:bg-zinc-900 transition-all group"
                >
        ...
        <section className="py-20 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-gradient-to-b from-zinc-900/80 to-zinc-900/40 border border-zinc-800 rounded-3xl p-12">
              ...
              <button
                onClick={() => {
                  document.getElementById("repo-input")?.scrollIntoView({ behavior: "smooth" });
